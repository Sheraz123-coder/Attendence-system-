...
<head>
    ...
    <title>Assign Task - Attendance System</title>
        ...
        <div class="card p-4">
            ...
            <form action="{{ route('admin.tasks.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" class="form-control" placeholder="Project Submission" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">Task Description</label>
                    <textarea name="description" id="editor" class="form-control" rows="5"></textarea>
                </div>
                <button type="submit" class="btn btn-primary px-5 py-2">Assign Task</button>
            </form>
        </div>
    </div>
